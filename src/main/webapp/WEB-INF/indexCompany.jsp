...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../../resources/static/css/public.css" />  <!-- 公用的css样式表 -->
		<link rel="stylesheet" href="../../resources/static/css/index.css" />     <!-- 后台首页样式表 -->
	</head>
	<!-- IE10以下的版本低版本警告 -->
	<!--[if lt IE 10]>
				...
				<div class="layui-main mag0">
					...
					<ul class="layui-nav top_menu">
						...
						<li class="layui-nav-item" id="userInfo">
							<a href="javascript:;">
<<<<<<< HEAD:src/main/webapp/WEB-INF/indexCompany.html
								<img src="images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35">
								<cite class="adminName">BY</cite>&nbsp;</a>
=======
								<img src="../../resources/static/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35">
								<cite class="adminName">哥哥</cite>&nbsp;</a>
>>>>>>> 498fa451870ef0000023ac104de7991b70cafe4d:src/main/webapp/WEB-INF/index2.html
...
=======
		<script type="text/javascript" src="../../resources/static/js"></script>
>>>>>>> 498fa451870ef0000023ac104de7991b70cafe4d:src/main/webapp/WEB-INF/index2.html
